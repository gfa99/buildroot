...
ifeq ($(BR2_TAKE_SYSROOT_FROM_ROOTFS),y)
	$(Q)$(TOPDIR)/support/scripts/take_sysroot_from_rootfs.sh $$(TARGET_DIR) $$(BASE_DIR)/sysroot $$(TOOLCHAIN_EXTERNAL_PREFIX) $$(TOOLCHAIN_EXTERNAL_INSTALL_DIR)
endif
	$(Q)rm -rf $$(TARGET_DIR)
